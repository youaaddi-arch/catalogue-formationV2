...
PIECES_OBLIGATOIRES = [
    ...
    },
    {
        ...
        "mots_cles": ["cni", "carte identité", "carte identite", "carte_identite",
                       "visa", "passeport", "passport", "titre séjour", "titre sejour",
                       "titre_sejour", "tds", "piece identite", "pièce identité",
                       "id_card", "identité", "identite", "sejour", "récépissé",
                       "recepisse", "ats", "aps"],
        "obligatoire": True,
    },
    {
        ...
        "mots_cles": ["planning", "calendrier", "emploi du temps", "edt"],
        "obligatoire": True,
    },
    {
        "id": "emargement",
        ...
        "mots_cles": ["émargement", "emargement", "présence", "presence",
                       "feuille_presence", "feuille de présence", "signature",
                       "appel"],
        "obligatoire": True,
    },
    {
        ...
        "mots_cles": ["attestation", "matériel", "materiel", "pc", "ordinateur",
                       "equipement", "équipement", "remise"],
        "obligatoire": True,
    },
]
